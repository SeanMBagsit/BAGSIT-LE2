...
END
GO
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = 'c6e37057-2bed-45a5-a0b6-c64017f79f4e')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('c6e37057-2bed-45a5-a0b6-c64017f79f4e')
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = 'd36541d7-da80-4ebf-9ee4-86e56a38b8eb')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('d36541d7-da80-4ebf-9ee4-86e56a38b8eb')
